...
st.write("LinkNet is a convolutional neural network for semantic segmentation that utilizes an encoder-decoder architecture with skip connections to preserve spatial information. It efficiently combines feature extraction and upsampling to produce accurate segmentation masks while maintaining computational efficiency.")
st.subheader("Model architecture")
image_file = "model_linknet.png"  

image = Image.open(image_file)
st.image(image, caption='Displayed Image.', use_column_width=True)

image_file = "graph_linknet.png"
st.subheader("Loss,Accuracy Graphs")
image = Image.open(image_file)
st.image(image, caption='Displayed Image.', use_column_width=True)
st.write("Upload an image and perform segmentation")

image_file = "image_linknet.png"
image = Image.open(image_file)
st.image(image, caption='Displayed Image.', use_column_width=True)

st.write("accuracy: 0.7177 - loss: 1.0716 ")
...
linknet_model=load_model('model_linknet.h5')
